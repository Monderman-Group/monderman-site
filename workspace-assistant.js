...
(function () {
  ...
  var css = ''
    ...
    + '#hans-panel{position:fixed;right:22px;bottom:94px;z-index:2147483000;width:384px;max-width:calc(100vw - 32px);height:564px;max-height:calc(100vh - 124px);background:#fff;border:1px solid #EAE6DD;border-radius:20px;box-shadow:0 26px 64px rgba(24,25,28,.20);display:none;flex-direction:column;overflow:hidden;font-family:"Neue Haas Grotesk","Helvetica Neue",Helvetica,Arial,sans-serif;color:#18191C}'
