...
(function () {
  ...
  var CSS = [
    ...
    '#mdn-fb-root{',
    '  --fb-ink:#18191C; --fb-muted:#6E6F73; --fb-surface:#FFFFFF; --fb-line:#EAE6DD;',
    '  --fb-accent:#0C6E78; --fb-accent-ink:#FFFFFF; --fb-ring:rgba(12,110,120,.20);',
    ...
    '  padding:11px 15px; border:1px solid var(--fb-line); border-radius:7px;',
    ...
    '.mdn-fb-x:hover{color:var(--fb-ink); background:#F1EEE7;}',
    ...
    '.mdn-fb-star{appearance:none; border:0; background:transparent; padding:2px; cursor:pointer; line-height:0; border-radius:6px; color:#D2CFC8;}',
    ...
    '  font-family:inherit; font-size:14px; line-height:1.45; padding:10px 11px; transition:border-color .14s ease, box-shadow .14s ease;',
    '}',
    '#mdn-fb-comment{min-height:88px; resize:vertical;}',
    '#mdn-fb-email{margin-top:2px;}',
    '#mdn-fb-comment:focus,#mdn-fb-email:focus{outline:none; border-color:#C2BFB6; box-shadow:0 0 0 3px var(--fb-ring);}',
    '#mdn-fb-comment::placeholder,#mdn-fb-email::placeholder{color:#9A9892;}',
    '.mdn-fb-field{margin-bottom:12px;}',
    '.mdn-fb-err{color:#B0392F; font-size:12px; margin:6px 0 0; display:none;}',
    ...
    '  font-family:inherit; font-size:13px; font-weight:600; line-height:1; letter-spacing:.01em; padding:10px 16px; border-radius:7px; white-space:nowrap;',
