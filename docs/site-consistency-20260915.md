...
- `methodology_business_copy_smoke.mjs`: **1,130** checks and **40** screenshots across Chromium/WebKit and phone/tablet/desktop. It opens the technical detail and checks retained financial conditions, source-link contrast/focus, fixed-header clearance, article figures and all homepage preview tabs.
