...
req(engine_fixture.get('engine_commit') == '07328e2a15ee16262e98e573e97c6bfd65659260', 'authenticated report fixture is not locked to the corrected API engine')
req(engine_fixture.get('claims_policy', {}).get('version') == 'bounded-nonclaims-v2' and engine_fixture.get('claims_policy', {}).get('status') == 'passed', 'authenticated report fixture is not claims-policy certified')
...
req('07328e2a15ee16262e98e573e97c6bfd65659260' in generator and 'cf47398f099791bbfd34328a5108caab16055e06' in generator, 'fixture generator is not locked to the corrected API engine and narrative blob')
