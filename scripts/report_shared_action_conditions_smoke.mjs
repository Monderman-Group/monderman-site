...
equal(Report.rendererVersion,'diagnostic-renderer-change-wording-20260925.1');
...
equal(sha(optionMarkup(Report.buildAIInterpretation(withOptions)).replaceAll('<dt>How to judge the change</dt>','<dt>How to judge the test</dt>')),'3aaa1e8e0ed0ab6bb167c1c09df84788c4c1d75e221c421c65de0a8bdea2ed91','Action options byte-identical outside exact condition-label wording');
