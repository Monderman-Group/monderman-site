...
const assetReleases = Object.freeze({
  "monderman-report.js": "20260925.changewording1",
  ...
  "campaign-analysis.js": "20260923.salary1",
...
const refreshedAssets = [
  ...
  "assignment-mode.js", "assignment-draft.js", "employer-salary-import.js", "employer-salary-settings.js", "sample-report-tile.css",
  "workspace-synthesis-readiness.css", "workspace-synthesis-readiness.js",
...
for (const entry of await readdir(publishDirectory, { withFileTypes: true })) {
  ...
  versionedHtml = versionScript(versionedHtml, "first-run-telemetry.js");
