...
assert((await page.locator('body').textContent()).includes('These reports use realistic example responses to demonstrate Monderman’s analysis and reporting.'), 'representative-output disclosure missing');
