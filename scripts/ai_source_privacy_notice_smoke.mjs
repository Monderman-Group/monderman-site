...
equal(manifest.required_acknowledgement,{terms_version:'2026-09-15-annual-plans',privacy_notice_version:version});
...
equal(sha(content(read('terms.html'))),'2dea883f1452b0158d61b12f10ce2bd3303642922c29754767faeb833f2a2215','Explicit approved annual Terms content');
equal(read('terms.html'),read('terms-2026-09-15-annual-plans.html'),'Current annual Terms have an exact new archive');
