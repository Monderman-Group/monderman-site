...
export function sourceBeforeRenderer38(source){
  if(source.includes('diagnostic-renderer-evidence-reading-20260913.39')||source.includes('diagnostic-renderer-evidence-reading-20260914.40'))source=sourceBeforeRenderer39(source);
