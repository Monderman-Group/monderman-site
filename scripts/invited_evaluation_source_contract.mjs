...
export function assertInvitedEvaluationSourceContract(root=path.resolve(import.meta.dirname,'..')){
  ...
  assert.equal(sha(read('enterprise-site.css')),'678148e7c962b257dd637f6ab9fcf74f9555c769475119abdfd8250e05a48a02','Only the reviewed primary/secondary CTA and promotional gold accents change shared CSS');
