...
for (const text of ['1.3.0','original-scorer','diagnostic-report-language-20260908','diagnostic-renderer-evidence-reading-20260914.40']) assert.ok(currentHtml.includes(text),text);
