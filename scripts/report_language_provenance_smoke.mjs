...
for (const text of ['1.3.0','original-scorer','diagnostic-report-language-20260908','diagnostic-renderer-report-overview-20260924.1']) assert.ok(currentHtml.includes(text),text);
