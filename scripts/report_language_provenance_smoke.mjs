...
for (const text of ['1.3.0','original-scorer','diagnostic-report-language-20260908','diagnostic-renderer-ai-screen-20260909.16']) assert.ok(currentHtml.includes(text),text);
