...
for (const text of ['1.3.0','original-scorer','diagnostic-report-language-20260908','diagnostic-renderer-ai-20260909.5']) assert.ok(currentHtml.includes(text),text);
