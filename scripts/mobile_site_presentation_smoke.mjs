...
const immutableLegalPages = new Set(pages.filter((name) => /^(?:terms|privacy)-\d{4}-\d{2}-\d{2}-(?:beta|optional-measurement-v1|ai-evidence-v1|ai-source-evidence-v2|annual-plans|invited-evaluation|invitation-access)\.html$/.test(name)));
