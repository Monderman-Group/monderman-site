...
assert.match(rendererSource,/RENDERER_VERSION = "diagnostic-renderer-evidence-reading-20260913\.39"/);
assert.match(pageSource,/monderman-report\.js\?v=20260913\.39/);
