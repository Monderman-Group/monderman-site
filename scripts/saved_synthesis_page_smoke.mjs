...
assert.match(rendererSource,/RENDERER_VERSION = "diagnostic-renderer-evidence-reading-20260914\.42"/);
assert.match(pageSource,/monderman-report\.js\?v=20260914\.42/);
