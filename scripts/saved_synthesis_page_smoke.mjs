...
assert.match(rendererSource,/RENDERER_VERSION = "diagnostic-renderer-evidence-reading-20260912\.31"/);
assert.match(pageSource,/monderman-report\.js\?v=20260912\.31/);
