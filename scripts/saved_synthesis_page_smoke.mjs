...
assert.match(rendererSource,/RENDERER_VERSION = "diagnostic-renderer-evidence-reading-20260913\.32"/);
assert.match(pageSource,/monderman-report\.js\?v=20260913\.32/);
