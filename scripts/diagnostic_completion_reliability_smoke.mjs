...
function validateCompletionContract(source, page = "fixture") {
  ...
  if (page === "decision-velocity.html") {
    assert.match(finalize, /certification_provider_outage[\s\S]*certificationProviderOutageInjected[\s\S]*certification_force_provider_outage:\s*injectCertificationOutage/, `${page}: one-shot synthetic provider-outage trigger missing`);
  }
