...
const read=file=>sourceBeforePublicSampleProjectionCache20260924(file,sourceBeforePublicSamplePreviewBinding20260924(file,sourceAtChangeWordingBaseline(file,fs.readFileSync(path.join(root,file),'utf8'))));
