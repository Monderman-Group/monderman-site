...
export function assertThreeBenefitSourceContract(root=path.resolve(import.meta.dirname,'..')){
  ...
  assert.equal(sha(read('monderman-depth-lure-tile.css')),'aec7bb37f680247b2e39e035b37fe9cf7fff1e7c99cf7922c8e672bdfe8750aa','Reviewed mobile three-benefit amount containment');
