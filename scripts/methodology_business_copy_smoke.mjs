...
check(read('scripts/inject-public-shell.mjs').includes('"homepage-workspace-demo.css": "20260920.gold1"'),'Build refreshes the reviewed selective-gold stylesheet cache ID');
