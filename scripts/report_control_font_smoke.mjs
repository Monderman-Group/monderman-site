...
const current='diagnostic-renderer-evidence-reading-20260913.36',previous='diagnostic-renderer-evidence-reading-20260913.35';
...
const prior=source.replace(current,previous).replace(fontRule,'border-radius:7px;font-size:15px;font-weight:500');
...
for(const raw of models){
  ...
  eq(html.replaceAll(current,previous).replace(fontRule,'border-radius:7px;font-size:15px;font-weight:500'),oldHtml,'All report content and controls unchanged outside font/version');
