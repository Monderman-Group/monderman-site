(function () {
  ...
  function validate(artifact) {
    ...
    if (projection.version !== 'monderman-public-sample-projection-20260912.5' || !sha256(projection.source_sha256) || !/^[a-f0-9]{40}$/.test(projection.projection_commit || '')) throw new Error("Sample publication version is missing");
