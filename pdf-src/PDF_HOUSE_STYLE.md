...
`Monderman_Insight_Built_to_Please_2026-09-02.pdf` is the canonical rendered reference for every new or revised PDF published on monderman.com. Preserve that file byte-for-byte when publishing it.
...
```text
python scripts/validate_pdf_house_style.py Monderman_Insight_Built_to_Please_2026-09-02.pdf
```
