...
(function(){
  'use strict';
  const VERSION='2026-09-12-ai-source-evidence-v2',PREFIX='monderman-note-choice-v1:';
  ...
  function mount(parent,runId){
    ...
    text.textContent="Allow these optional observations to be used by Anthropic for my Diagnostic report and my organization’s Synthesis reports under this notice.";
    ...
    const link=document.createElement('a');link.href='privacy-2026-09-12-ai-source-evidence-v2.html';link.target='_blank';link.rel='noopener';link.textContent='Read the processing and retention notice';help.append(link);box.append(help);parent.append(box);
  }
