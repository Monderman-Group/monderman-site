...
(function () {
  ...
  var REPORT_CSS =
    ...
    .mr-report .mr-report-boundary{display:block!important;grid-template-columns:none!important;margin:-18px 0 46px;padding:20px 22px;background:#F6F3EC;border:1px solid rgba(12,110,120,.18);border-left:4px solid #0C6E78;border-radius:0 12px 12px 0}.mr-report .mr-report-boundary-mark{display:none}.mr-report .mr-report-boundary-label{font-size:.7rem!important;letter-spacing:.17em}
